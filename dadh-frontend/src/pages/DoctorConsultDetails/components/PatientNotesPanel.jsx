...
function PatientNotesPanel({ notes, onChange, onToggleScribe, isScribing }) {
  return (
    <div style={{ background: "white", border: "1px solid #D1E8E8", borderRadius: 12, overflow: "hidden", display: "flex", flexDirection: "column", minHeight: 0 }}>
      ...
      <textarea
        ...
        style={{ flex: 1, border: "none", outline: "none", resize: "none", padding: "14px 16px", fontSize: 14, color: "#111E1F", background: "transparent", minHeight: 0, fontFamily: "inherit" }}
      />
    </div>
  )
}
