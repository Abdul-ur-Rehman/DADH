...
const { authLimiter, doctorLoginLimiter, registerLimiter } = require('../middlewares/rate-limit-middleware')
...
router.post('/login', doctorLoginLimiter, validator(loginSchema), doctorController.login)
